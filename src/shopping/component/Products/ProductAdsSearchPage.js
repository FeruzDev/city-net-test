...
class ProductAdsSearchPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            posts: [],
    ...
    componentDidMount() {
        axios.get(API_PATH_MAIN + "advertisement-list/?search=" + this.props.match.params.search)
            .then(res => {
    ...
    render() {
        ...
        const search = () => {
            axios.get(API_PATH_MAIN + "advertisement-list/?search=" + this.state.inputText)
                .then(res => {
                    this.setState({news: res.data.results})
                })
        }
                        ...
                        <Row>
                            ...
                            <Col md={4}>
                                <div className="inputGroupM">
                                    ...
                                    <Link to={'/main-product/ads/' + this.state.inputText} onClick={search} className=" pt-2 searchBtn">ПОИСК</Link>
                                </div>
...
export default ProductAdsSearchPage;